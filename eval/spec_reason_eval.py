# python spec_reason_eval.py --dataset_name aime --model_name QwQ-32B --results_dir results/spec_7
    ...
    for filename in os.listdir(model_dir):
        ...
        try:
            ...
            if result is None:
                ...
                # # 检查答案是否正确
                is_correct = compare_answers(result, ground_truth, args.dataset_name)
                ...
                if is_correct:
                    ...
                    logging.info(f"问题 {problem_id}（索引 {problem_idx}），重复 {repeat_id}: 模型='{result}'，正确答案='{ground_truth}'，判断={is_correct}")
