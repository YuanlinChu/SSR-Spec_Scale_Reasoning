...
#python baseline_eval.py --dataset_name math --model_name QwQ-32B --results_dir results/scale_reason_r3_noprompt
#python baseline_eval.py --dataset_name live --model_name QwQ-32B --results_dir results/scale_reason_r3_noprompt
#该文件评估base_test.py和scale_reason.py的输出
import os
import re
import pickle
import argparse
...
def evaluate_model(args):
    ...
    # 设置特定日志文件路径
    log_filename = f"{log_dir}/{args.dataset_name}_{args.model_name}.log"
    ...
    logging.info(f"评估日志将保存到: {log_filename}")
