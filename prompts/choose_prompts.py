...
math_choose_prompt = """
You will be given a general math problem. First, read the list of possible solution strategies below (A–M), then select strategies that are most promising for solving the problem.
...
gpqa_choose_prompt = """
You will be given a multiple choice problem from GPQA (Graduate-level Physics Questions and Answers). First, read the list of possible solution strategies below (A–M), then select strategies that are most promising for solving the problem.
