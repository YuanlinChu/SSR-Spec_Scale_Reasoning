# python api_spec_scale_2.py --dataset_name aime --problem_id 60 --repeat_id 3 --output_dir results/api_spec_scale_2 --score_threshold 7.0 --token_budget 8192 --score_method greedy --method_num 3
...
async def run_reasoning_track(track):
    """运行单个推理轨道直到完成"""
    while await track.process_step():
        pass
    return track.get_result()
...
async def main_async():
    ...
    for problem_id in problem_ids:
        ...
        logging.info(f"处理问题 ID: {problem_id}，重复 {args.repeat_id}")
        await run_speculative_reasoning_async(args, problem_id, args.repeat_id)
        completed_tasks += 1
